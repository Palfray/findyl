...
Handling records by the grooves. Always hold by the edges and the label. The oils from your fingers settle into grooves and attract dust that bonds to the surface. If you've been handling records carelessly, a proper wet clean will help — have a look at our [cleaning guide](/articles/how-to-clean-vinyl-records) for the full walkthrough.
...
And if you're buying used vinyl — where condition is everything and the difference between a VG+ and a NM copy can be fifteen or twenty quid — knowing how to store properly means knowing what to look for in a seller, too. A well-stored collection tells you a lot about the person who owned it.
